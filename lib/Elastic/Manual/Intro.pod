...
Clinton Gormley, author of Elastic::Model have said:
...
Only a few of Us told him how we use it and from my point of view, after
reading there and talking with other users, Clinton is right when he says
that Elastic::Model is doing too much...
...
understand, but I was able to make almost all tests pass using 2.4

I need to test back on 1.x but now I can see I can make it. On the other hand
I've discovered that maintaining support for 0.9 will be a harder work that
I'm not interested so my plan is to completely remove support for it and try
